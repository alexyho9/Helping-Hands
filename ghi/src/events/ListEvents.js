      ...
      >
          <Container maxWidth="sm">
            ...
            <Typography variant="h5" align="center" color="white" paragraph>
              Here is a list of events that helping hands is currently offering for those who want to particpate or volunteer
            </Typography>
            <Stack
              sx={{ pt: 4 }}
              direction="row"
            ...
            {events.map((event) => (
              <Grid item key={event.id} xs={12} sm={6} md={4}>
                ...
                >
                  ...
                  <CardActions>
                    <Button size="small" href={'http://localhost:3000/events/' + event.id}> View </Button>
                  </CardActions>
                </Card>
              </Grid>
            ))}
